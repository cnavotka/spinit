...
* Edit product (Change the default 'No image" for a random image)
...
Here you can find the screenshots testing if the login and CRUD operations for the admin in the <https://cnavotka-spin-it.herokuapp.com/admin/login/?next=/admin/> of the deployed site as admin/superuser works.

* Add product (Added product Test in the headphones category)
![Add product](https://github.com/cnavotka/spinit/blob/main/static/images/test-add-product-panel.png)

* Edit product (Added random image to the product)
![Edit product](https://github.com/cnavotka/spinit/blob/main/static/images/test-edit-product-admin-panel.png)

* Delete product (The product Test was deleted and doesn't appears above Aphex Twin)
![Delete product](https://github.com/cnavotka/spinit/blob/main/static/images/test-delete-product-admin-panel.png)
